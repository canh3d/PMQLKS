...
namespace QLKS_AnPhu.View
{
    ...
    {
        public ThanhToanCheckInWindow(string moTa, decimal tienPhong, decimal tienDichVu, decimal phuPhi, decimal datCoc, decimal giamGia, string? moTaPhuPhi = null)
        {
            InitializeComponent();
            ...
            TxtPhuPhiLabel.Text = string.IsNullOrWhiteSpace(moTaPhuPhi) ? "Phụ phí nhận sớm" : moTaPhuPhi;
